/*
 * @Author: Sha Jun
 * @Date: 2021-03-01 15:48:57
 * @LastEditTime: 2021-03-01 17:14:13
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: \Frontend-09-Template\Week_01\js\TicTacToe_AI_final.js
 */
...
function build() {
  ...
  for (let y = 0; y < 3; y++) {
    for (let x = 0; x < 3; x++) {
      ...
      cell.addEventListener("click", () => userMove(x, y)); // 《 == 这里加入监听事件
